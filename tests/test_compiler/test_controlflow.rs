...
fn switch() -> VM {
    ...
    emit_test!      ((vm) (switch switch_test1 switch_test1_v1 Int,Int,EQ (switch_sig, int64(0u64), int64(0u64))));
    emit_test!      ((vm) (switch switch_test2 switch_test2_v1 Int,Int,EQ (switch_sig, int64(1u64), int64(1u64))));
    emit_test!      ((vm) (switch switch_test3 switch_test3_v1 Int,Int,EQ (switch_sig, int64(2u64), int64(2u64))));
    emit_test!      ((vm) (switch switch_test4 switch_test4_v1 Int,Int,EQ (switch_sig, int64(3u64), int64(99u64))));
...
fn select_eq_zero() -> VM {
    ...
    emit_test!      ((vm) (select_eq_zero select_eq_zero_test1 select_eq_zero_test1_v1 Int,Int,EQ (sig, int64(0u64), int64(1u64))));
    emit_test!      ((vm) (select_eq_zero select_eq_zero_test2 select_eq_zero_test2_v1 Int,Int,EQ (sig, int64(1u64), int64(0u64))));
...
fn select_u8_eq_zero() -> VM {
    ...
    emit_test!      ((vm) (select_u8_eq_zero select_u8_eq_zero_test1 select_u8_eq_zero_test1_v1 Int,Int,EQ (sig, int8(0u64), int8(1u64))));
    emit_test!      ((vm) (select_u8_eq_zero select_u8_eq_zero_test2 select_u8_eq_zero_test2_v1 Int,Int,EQ (sig, int8(1u64), int8(0u64))));
...
fn select_sge_zero() -> VM {
    ...
    emit_test!      ((vm) (select_sge_zero select_sge_zero_test1 select_sge_zero_test1_v1 Int,Int,EQ (sig, int64(0u64), int64(1u64))));
    emit_test!      ((vm) (select_sge_zero select_sge_zero_test2 select_sge_zero_test2_v1 Int,Int,EQ (sig, int64(1u64), int64(1u64))));
    emit_test!      ((vm) (select_sge_zero select_sge_zero_test3 select_sge_zero_test3_v1 Int,Int,EQ (sig, int64(-1i64 as u64), int64(0u64))));
...
fn sgt_value() -> VM {
    ...
    emit_test!      ((vm) (sgt_value sgt_value_test1 sgt_value_test1_v1 Int,Int,Int,EQ (sig, int64(255u64), int64(0u64), int1(1u64))));
    emit_test!      ((vm) (sgt_value sgt_value_test2 sgt_value_test2_v1 Int,Int,Int,EQ (sig, int64(255u64), int64(255u64), int1(0u64))));
    emit_test!      ((vm) (sgt_value sgt_value_test3 sgt_value_test3_v1 Int,Int,Int,EQ (sig, int64(0u64), int64(255u64), int1(0u64))));
...
fn sgt_u8_value() -> VM {
    ...
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test1 sgt_u8_value_test1_v1 Int,Int,Int,EQ (sig, int8(-1i8 as u64), int8(0i8 as u64), int1(0u64))));
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test2 sgt_u8_value_test2_v1 Int,Int,Int,EQ (sig, int8(0i8 as u64), int8(-1i8 as u64), int1(1u64))));
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test3 sgt_u8_value_test3_v1 Int,Int,Int,EQ (sig, int8(2i8 as u64), int8(1i8 as u64), int1(1u64))));
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test4 sgt_u8_value_test4_v1 Int,Int,Int,EQ (sig, int8(1i8 as u64), int8(2i8 as u64), int1(0u64))));
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test5 sgt_u8_value_test5_v1 Int,Int,Int,EQ (sig, int8(-2i8 as u64), int8(-1i8 as u64), int1(0u64))));
    emit_test!      ((vm) (sgt_u8_value sgt_u8_value_test6 sgt_u8_value_test6_v1 Int,Int,Int,EQ (sig, int8(-1i8 as u64), int8(-2i8 as u64), int1(1u64))));
...
fn sgt_i32_branch() -> VM {
    ...
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test1 sgt_i32_branch_test1_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(0i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test2 sgt_i32_branch_test2_v1 Int,Int,Int,EQ (sig, int32(0i32 as u64), int32(-1i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test3 sgt_i32_branch_test3_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(-1i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test4 sgt_i32_branch_test4_v1 Int,Int,Int,EQ (sig, int32(2i32 as u64), int32(1i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test5 sgt_i32_branch_test5_v1 Int,Int,Int,EQ (sig, int32(1i32 as u64), int32(2i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test6 sgt_i32_branch_test6_v1 Int,Int,Int,EQ (sig, int32(2i32 as u64), int32(2i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test7 sgt_i32_branch_test7_v1 Int,Int,Int,EQ (sig, int32(-2i32 as u64), int32(-1i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test8 sgt_i32_branch_test8_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(-2i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sgt_i32_branch sgt_i32_branch_test9 sgt_i32_branch_test9_v1 Int,Int,Int,EQ (sig, int32(0i32 as u64), int32(0i32 as u64), int32(0u64))));
...
fn sge_i32_branch() -> VM {
    ...
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test1 sge_i32_branch_test1_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(0i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test2 sge_i32_branch_test2_v1 Int,Int,Int,EQ (sig, int32(0i32 as u64), int32(-1i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test3 sge_i32_branch_test3_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(-1i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test4 sge_i32_branch_test4_v1 Int,Int,Int,EQ (sig, int32(2i32 as u64), int32(1i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test5 sge_i32_branch_test5_v1 Int,Int,Int,EQ (sig, int32(1i32 as u64), int32(2i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test6 sge_i32_branch_test6_v1 Int,Int,Int,EQ (sig, int32(2i32 as u64), int32(2i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test7 sge_i32_branch_test7_v1 Int,Int,Int,EQ (sig, int32(-2i32 as u64), int32(-1i32 as u64), int32(0u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test8 sge_i32_branch_test8_v1 Int,Int,Int,EQ (sig, int32(-1i32 as u64), int32(-2i32 as u64), int32(1u64))));
    emit_test!      ((vm) (sge_i32_branch sge_i32_branch_test9 sge_i32_branch_test9_v1 Int,Int,Int,EQ (sig, int32(0i32 as u64), int32(0i32 as u64), int32(1u64))));
...
fn branch2_eq_50p_1() -> VM {
    ...
    emit_test!      ((vm) (branch2_eq_50p_1 branch2_eq_50p_1_test1 branch2_eq_50p_1_test1_v1 Int,Int,EQ (sig, int8(1u64), int64(1u64))));
    emit_test!      ((vm) (branch2_eq_50p_1 branch2_eq_50p_1_test2 branch2_eq_50p_1_test2_v1 Int,Int,EQ (sig, int8(0u64), int64(0u64))));
...
fn branch2_eq_50p_2() -> VM {
    ...
    emit_test!      ((vm) (branch2_eq_50p_2 branch2_eq_50p_2_test1 branch2_eq_50p_2_test1_v1 Int,Int,EQ (sig, int8(1u64), int64(1u64))));
    emit_test!      ((vm) (branch2_eq_50p_2 branch2_eq_50p_2_test2 branch2_eq_50p_2_test2_v1 Int,Int,EQ (sig, int8(0u64), int64(0u64))));
...
fn branch2_high_prob_branch_cannot_fallthrough() -> VM {
    ...
    emit_test!      ((vm) (branch2 branch2_test1 branch2_test1_v1 Int,Int,EQ (sig, int8(1u64), int64(1u64))));
    emit_test!      ((vm) (branch2 branch2_test2 branch2_test2_v1 Int,Int,EQ (sig, int8(0u64), int64(0u64))));
