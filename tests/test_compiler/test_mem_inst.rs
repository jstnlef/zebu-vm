...
fn test_store_seqcst() {
    ...
    unsafe {
        ...
        let store_seqcst: libloading::Symbol<unsafe extern "C" fn(*mut u64, u64)> = lib.get(b"store_seqcst").unwrap();
...
fn test_write_int8_val() {
    ...
    unsafe {
        ...
        let write_int8: libloading::Symbol<unsafe extern "C" fn(*mut Foo, i8)> = lib.get(b"write_int8").unwrap();
...
fn test_write_int8_const() {
    ...
    unsafe {
        ...
        let write_int8: libloading::Symbol<unsafe extern "C" fn(*mut Foo)> = lib.get(b"write_int8_const").unwrap();
...
fn test_get_iref() {
    ...
    unsafe {
        let get_iref: libloading::Symbol<unsafe extern "C" fn(u64) -> u64> = lib.get(b"get_iref").unwrap();
...
fn test_struct() {
    ...
    let executable = aot::link_primordial(vec![Arc::new("struct_insts".to_string())], "struct_insts_test", &vm);
...
fn test_get_elem_iref_array_ele_9bytes() {
    ...
    unsafe {
        let get_elem_iref_array_ele_9bytes: libloading::Symbol<unsafe extern "C" fn(u64, u64) -> u64> =
