...
fn test_udiv_u128() {
    ...
    unsafe {
        ...
        let udiv_u128: libloading::Symbol<unsafe extern "C" fn(u64, u64, u64, u64) -> (u64, u64)> =
...
fn test_lshr_u128() {
    ...
    unsafe {
        let lshr_u128: libloading::Symbol<unsafe extern "C" fn(u64, u64, u64, u64) -> (u64, u64)> =
...
fn test_ashr_u128() {
    ...
    unsafe {
        let ashr_u128: libloading::Symbol<unsafe extern "C" fn(u64, u64, u64, u64) -> (u64, u64)> =
...
fn test_store_load_u128() {
    ...
    unsafe {
        ...
        let store_load_u128: libloading::Symbol<unsafe extern "C" fn(u64, u64, *mut u64) -> (u64, u64)> =
...
fn test_sgt_i128() {
    ...
    unsafe {
        ...
        let sgt_i128: libloading::Symbol<unsafe extern "C" fn(i128, i128) -> u64> = lib.get(b"sgt_i128").unwrap();
...
fn test_slt_i128() {
    ...
    unsafe {
        ...
        let slt_i128: libloading::Symbol<unsafe extern "C" fn(i128, i128) -> u64> = lib.get(b"slt_i128").unwrap();
