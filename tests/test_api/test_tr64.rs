...
fn test_other_bit_pattern_is_double() {
    ...
    unsafe {
        assert!(vm.handle_tr64_is_fp(&tr64(transmute(3.1415927f64))));
    }
}
...
fn test_encode_double() {
    ...
    unsafe {
        assert_eq!(
            vm.handle_tr64_from_fp(&double(3.14_f64)).v.as_tr64(),
            transmute(3.14_f64)
        );
        assert_eq!(
            vm.handle_tr64_from_fp(&double(-3.14_f64)).v.as_tr64(),
        ...
        assert_eq!(
            vm.handle_tr64_from_fp(&double(f64::INFINITY)).v.as_tr64(),
...
fn test_encode_tagref() {
    ...
    assert_eq!(
        vm.handle_tr64_from_ref(&ref_void(0x000000000000u64), &tag(0x00u64))
            .v
            .as_tr64(),
        0x7ff0000000000002u64
    );
    assert_eq!(
        vm.handle_tr64_from_ref(&ref_void(0x7ffffffffff8u64), &tag(0x00u64))
            .v
            .as_tr64(),
        0x7ff07ffffffffffau64
    );
    assert_eq!(
        vm.handle_tr64_from_ref(&ref_void(0xfffffffffffffff8u64), &tag(0x00u64))
            .v
            .as_tr64(),
        0xfff07ffffffffffau64
    );
    assert_eq!(
        vm.handle_tr64_from_ref(&ref_void(0x000000000000u64), &tag(0x3fu64))
            .v
            .as_tr64(),
        0x7fff800000000006u64
    );
}
...
fn test_decode_tagref() {
    ...
    assert_eq!(
        vm.handle_tr64_to_ref(&tr64(0x7ff0555555555552u64))
            .v
            .as_ref()
            .1
            .as_usize() as u64,
    ...
    assert_eq!(
        vm.handle_tr64_to_ref(&tr64(0xfff02aaaaaaaaaaau64))
            .v
            .as_ref()
            .1
            .as_usize() as u64,
